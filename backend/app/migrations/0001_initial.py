# Generated by Django 4.2.7 on 2025-02-18 00:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('plan_volume', models.IntegerField(blank=True, default=0, null=True, verbose_name='Плановый обьем')),
                ('volume', models.IntegerField(blank=True, null=True, verbose_name='Реальный обьем')),
