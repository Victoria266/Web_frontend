...
class ResourceReport(models.Model):
    ...
    plan_volume = models.IntegerField(verbose_name="Плановый обьем", blank=True, null=True)
    volume = models.IntegerField(verbose_name="Реальный обьем", default=0, blank=True, null=True)
