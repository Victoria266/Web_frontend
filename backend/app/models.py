...
class Resource(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name="Новый ресурс")
...
class ResourceReport(models.Model):
    ...
    plan_volume = models.IntegerField(verbose_name="Плановый обьем", default=0, blank=True, null=True)
    volume = models.IntegerField(verbose_name="Реальный обьем", blank=True, null=True)
